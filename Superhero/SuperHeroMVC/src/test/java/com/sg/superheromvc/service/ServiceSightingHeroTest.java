 ...
 * @author Anna
 */
public class ServiceSightingHeroTest {
    ...
    private ServiceLayerHeroOrg serviceHeroOrg;
     ...
     public ServiceSightingHeroTest() {
    }
    ...
    public void addGetDeleteSighting_Hero() throws ParseException {
        ...
        serviceSightHero.addSightingForHero(SH);
        int idSH = SH.getIdSightingHero();
        Sighting_has_Hero fromDb = serviceSightHero.getSightingForHero(idSH);
        
        
       
        assertEquals(fromDb.getIdSightingHero(), SH.getIdSightingHero()); //passes
        serviceSightHero.deleteSightingForHero(SH.getIdSightingHero()); //passes
        assertEquals(serviceSightHero.getAllSightingsForHero().size(), 0); //passes
    }
    ...
    public void addUpdateSightingHero() throws ParseException {
        ...
        serviceSightHero.updateSightingForHero(fromDb);
        
        Sighting_has_Hero updatedSH = serviceSightHero.getSightingForHero(fromDb.getIdSightingHero());
    ...
    public void getAllSightingsForDateTest() throws ParseException {
        ...
        serviceSightHero.addSightingForHero(SH);
        int idSH = SH.getIdSightingHero();
        Sighting_has_Hero fromDb1 = serviceSightHero.getSightingForHero(idSH);
      ...
      List<Sighting_has_Hero> sightingsByDateList = serviceSightHero.getAllSightingsByDate(date2);
